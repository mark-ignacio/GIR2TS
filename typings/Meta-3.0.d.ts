...
declare namespace imports.gi.Meta {
	...
	interface IBackgroundActor {
		...
		connect(signal: "notify::dim_factor", callback: (owner: this, ...args: any) => number): number;
	...
	interface IDisplay {
		...
		connect(signal: "notify::focus_window", callback: (owner: this, ...args: any) => number): number;
	...
	interface IPlugin {
		...
		connect(signal: "notify::debug_mode", callback: (owner: this, ...args: any) => number): number;
	...
	interface IScreen {
		...
		connect(signal: "notify::keyboard_grabbed", callback: (owner: this, ...args: any) => number): number;
		connect(signal: "notify::n_workspaces", callback: (owner: this, ...args: any) => number): number;
	...
	interface IWindow {
		...
		connect(signal: "notify::above", callback: (owner: this, ...args: any) => number): number;
		connect(signal: "notify::appears_focused", callback: (owner: this, ...args: any) => number): number;
		connect(signal: "notify::decorated", callback: (owner: this, ...args: any) => number): number;
		connect(signal: "notify::demands_attention", callback: (owner: this, ...args: any) => number): number;
		connect(signal: "notify::fullscreen", callback: (owner: this, ...args: any) => number): number;
		connect(signal: "notify::gtk_app_menu_object_path", callback: (owner: this, ...args: any) => number): number;
		connect(signal: "notify::gtk_application_id", callback: (owner: this, ...args: any) => number): number;
		connect(signal: "notify::gtk_application_object_path", callback: (owner: this, ...args: any) => number): number;
		connect(signal: "notify::gtk_menubar_object_path", callback: (owner: this, ...args: any) => number): number;
		connect(signal: "notify::gtk_unique_bus_name", callback: (owner: this, ...args: any) => number): number;
		connect(signal: "notify::gtk_window_object_path", callback: (owner: this, ...args: any) => number): number;
		connect(signal: "notify::maximized_horizontally", callback: (owner: this, ...args: any) => number): number;
		connect(signal: "notify::maximized_vertically", callback: (owner: this, ...args: any) => number): number;
		connect(signal: "notify::minimized", callback: (owner: this, ...args: any) => number): number;
		connect(signal: "notify::muffin_hints", callback: (owner: this, ...args: any) => number): number;
		connect(signal: "notify::progress", callback: (owner: this, ...args: any) => number): number;
		connect(signal: "notify::progress_pulse", callback: (owner: this, ...args: any) => number): number;
		connect(signal: "notify::resizeable", callback: (owner: this, ...args: any) => number): number;
		connect(signal: "notify::tile_type", callback: (owner: this, ...args: any) => number): number;
		connect(signal: "notify::title", callback: (owner: this, ...args: any) => number): number;
		connect(signal: "notify::urgent", callback: (owner: this, ...args: any) => number): number;
		connect(signal: "notify::user_time", callback: (owner: this, ...args: any) => number): number;
		connect(signal: "notify::window_type", callback: (owner: this, ...args: any) => number): number;
	...
	interface IWindowActor {
		...
		connect(signal: "notify::meta_screen", callback: (owner: this, ...args: any) => number): number;
		connect(signal: "notify::meta_window", callback: (owner: this, ...args: any) => number): number;
		connect(signal: "notify::no_shadow", callback: (owner: this, ...args: any) => number): number;
		connect(signal: "notify::shadow_class", callback: (owner: this, ...args: any) => number): number;
		connect(signal: "notify::x_window", callback: (owner: this, ...args: any) => number): number;
	...
	interface IWorkspace {
		...
		connect(signal: "notify::n_windows", callback: (owner: this, ...args: any) => number): number;
