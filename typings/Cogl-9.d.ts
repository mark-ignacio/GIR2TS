...
declare namespace imports.gi.Cogl {
	...
	interface IFramebuffer {
		 ...
		 * @returns 
		 */
		create_timestamp_query(): TimestampQuery;
		/**
		...
		connect(signal: "notify::driver-config", callback: (owner: this, ...args: any) => void): number;
	...
	type FramebufferInitOptionsMixin = GObject.ObjectInitOptions & 
	Pick<IFramebuffer,
		"context" |
		"driver_config" |
		"height" |
	 ...
	 * use {@link Framebuffer} instead.
	 */
	type FramebufferMixin = IFramebuffer & GObject.Object;
	...
	type OffscreenInitOptionsMixin = FramebufferInitOptions
	export interface OffscreenInitOptions extends OffscreenInitOptionsMixin {}

	/** This construct is only for enabling class multi-inheritance,
	 * use {@link Offscreen} instead.
	 */
	type OffscreenMixin = IOffscreen & Framebuffer;
	...
	type OnscreenInitOptionsMixin = FramebufferInitOptions
	export interface OnscreenInitOptions extends OnscreenInitOptionsMixin {}

	/** This construct is only for enabling class multi-inheritance,
	 * use {@link Onscreen} instead.
	 */
	type OnscreenMixin = IOnscreen & Framebuffer;
	...
	export interface FramebufferDriverConfigInitOptions {}
	interface FramebufferDriverConfig {}
	class FramebufferDriverConfig {
		public constructor(options?: Partial<FramebufferDriverConfigInitOptions>);
	}
	...
	class Material {
		 ...
		 * @param matrix the transformation matrix for the layer
		 */
		public set_layer_matrix(layer_index: number, matrix: Graphene.Matrix): void;
		/**
		 * @deprecated
	...
	export interface TimestampQueryInitOptions {}
	interface TimestampQuery {}
	class TimestampQuery {
		public constructor(options?: Partial<TimestampQueryInitOptions>);
	}

	export interface TraceContextInitOptions {}
	interface TraceContext {}
	class TraceContext {
		public constructor(options?: Partial<TraceContextInitOptions>);
	}

	export interface TraceHeadInitOptions {}
	interface TraceHead {}
	class TraceHead {
		public constructor(options?: Partial<TraceHeadInitOptions>);
	 ...
	 * operations. Note that {@link Gdk.pixbuf_new_from_file} can also throw
	 ...
	 * @param framebuffer The source {@link Framebuffer}
	 * @param dst The destination {@link Framebuffer}
