declare namespace imports.gi.Graphene {
	...
	class Box {
		 ...
		 */
		public expand_scalar(scalar: number): void;
		/**
		 ...
		 */
		public expand_vec3(vec: Vec3): void;
		/**
		 ...
		 * #graphene_box_t.
		 */
		public get_bounding_sphere(): void;
		/**
	...
	class Euler {
		 ...
		 */
		public reorder(order: EulerOrder): void;
		/**
	...
	class Matrix {
		 ...
		 */
		public get_row(index_: number): void;
		/**
		 ...
		 */
		public interpolate(_b: Matrix, factor: number): void;
		/**
		 ...
		 * @param _b a #graphene_matrix_t
		 */
		public multiply(_b: Matrix): void;
		/**
		 ...
		 */
		public perspective(depth: number): void;
		/**
		 ...
		 */
		public project_point(_p: Point): void;
		/**
		 ...
		 */
		public project_rect(_r: Rect): void;
		/**
		 ...
		 * @param _r a #graphene_rect_t
		 */
		public project_rect_bounds(_r: Rect): void;
		/**
		 ...
		 * @param _r a #graphene_rect_t
		 */
		public transform_bounds(_r: Rect): void;
		/**
		 ...
		 * @param _b a #graphene_box_t
		 */
		public transform_box(_b: Box): void;
		/**
		 ...
		 * @param _p a #graphene_point_t
		 */
		public transform_point(_p: Point): void;
		/**
		 ...
		 */
		public transform_vec3(_v: Vec3): void;
		/**
		 ...
		 */
		public transform_vec4(_v: Vec4): void;
		/**
		 ...
		 */
		public unproject_point3d(modelview: Matrix, point: Point3D): void;
		/**
		 ...
		 */
		public untransform_bounds(_r: Rect, bounds: Rect): void;
		/**
		 ...
		 */
		public untransform_point(_p: Point, bounds: Rect): boolean;
	}
	...
	class Plane {
		 ...
		 */
		public transform(matrix: Matrix, normal_matrix: Matrix | null): void;
	}
	...
	class Point {
		 ...
		 * @param factor the linear interpolation factor
		 */
		public interpolate(_b: Point, factor: number): void;
		/**
	...
	class Point3D {
		 ...
		 */
		public interpolate(_b: Point3D, factor: number): void;
		/**
		 ...
		 */
		public normalize_viewport(viewport: Rect, z_near: number, z_far: number): void;
		/**
	...
	class Quaternion {
		 ...
		 * @param _b a #graphene_quaternion_t
		 */
		public multiply(_b: Quaternion): void;
		/**
		 ...
		 * @param factor the linear interpolation factor
		 */
		public slerp(_b: Quaternion, factor: number): void;
		/**
	...
	class Ray {
		 ...
		 * @param _p a #graphene_point3d_t
		 */
		public get_closest_point_to_point(_p: Point3D): void;
		/**
		 * Retrieves the direction of the given #graphene_ray_t.
		 */
		public get_direction(): void;
		/**
		 ...
		 */
		public get_position_at(_t: number): void;
		/**
	...
	class Rect {
		 ...
		 */
		public get_bottom_left(): void;
		/**
		 * Retrieves the coordinates of the bottom-right corner of the given rectangle.
		 */
		public get_bottom_right(): void;
		/**
		 ...
		 */
		public get_top_left(): void;
		/**
		 * Retrieves the coordinates of the top-right corner of the given rectangle.
		 */
		public get_top_right(): void;
		/**
		 ...
		 * @param d_y the vertical inset
		 */
		public inset_r(d_x: number, d_y: number): void;
		/**
		 ...
		 * @param factor the linear interpolation factor
		 */
		public interpolate(_b: Rect, factor: number): void;
		/**
		 ...
		 * @param d_y the vertical offset
		 */
		public offset_r(d_x: number, d_y: number): void;
		/**
		 ...
		 */
		public scale(s_h: number, s_v: number): void;
		/**
	...
	class Size {
		 ...
		 * @param factor the linear interpolation factor
		 */
		public interpolate(_b: Size, factor: number): void;
		/**
	...
	class Sphere {
		 ...
		 */
		public translate(point: Point3D): void;
	}
	...
	class Triangle {
		 ...
		 */
		public get_barycoords(_p: Point3D | null): boolean;
		/**
		 ...
		 */
		public get_uv(_p: Point3D | null, uv_a: Vec2, uv_b: Vec2, uv_c: Vec2): boolean;
		/**
	...
	class Vec2 {
		 ...
		 * @param factor the interpolation factor
		 */
		public interpolate(v2: Vec2, factor: number): void;
		/**
	...
	class Vec3 {
		 ...
		 * @param _b a #graphene_vec3_t
		 */
		public add(_b: Vec3): void;
		/**
		 * Computes the cross product of the two given vectors.
		 * @param _b a #graphene_vec3_t
		 */
		public cross(_b: Vec3): void;
		/**
		 * Divides each component of the first operand #a by the corresponding
		 * component of the second operand #b, and places the results into the
		 * vector #res.
		 ...
		 */
		public get_xyzw(_w: number): void;
		/**
		 ...
		 * @param factor the interpolation factor
		 */
		public interpolate(v2: Vec3, factor: number): void;
		/**
		 ...
		 * @param _b a #graphene_vec3_t
		 */
		public max(_b: Vec3): void;
		/**
		 * Compares each component of the two given vectors and creates a
		 * vector that contains the minimum values.
		 * @param _b a #graphene_vec3_t
		 */
		public min(_b: Vec3): void;
		/**
		 * Multiplies each component of the two given vectors.
		 * @param _b a #graphene_vec3_t
		 */
		public multiply(_b: Vec3): void;
		/**
	...
	class Vec4 {
		 ...
		 * @param factor the interpolation factor
		 */
		public interpolate(v2: Vec4, factor: number): void;
		/**
		 ...
		 * @param _b a #graphene_vec4_t
		 */
		public max(_b: Vec4): void;
		/**
		 * Compares each component of the two given vectors and creates a
		 * vector that contains the minimum values.
		 * @param _b a #graphene_vec4_t
		 */
		public min(_b: Vec4): void;
		/**
		 * Multiplies each component of the two given vectors.
		 * @param _b a #graphene_vec4_t
		 */
		public multiply(_b: Vec4): void;
		/**
