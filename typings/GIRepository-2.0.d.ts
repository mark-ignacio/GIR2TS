...
declare namespace imports.gi.GIRepository {
	...
	interface IRepository {
		 ...
		 * @returns Zero-terminated string array of all versioned
		 *   dependencies
		 */
	...
	class Repository {
		 ...
		 */
		public static get_search_path(): GLib.SList;
	 ...
	 * words, {@link G.base_info_unref} has to be called when done accessing the data.
