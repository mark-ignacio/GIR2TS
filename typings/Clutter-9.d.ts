...
declare namespace imports.gi.Clutter {
	...
	interface IActor {
		 ...
		 * {@link Actor.child_transform_set} property to %TRUE as a side effect;
		 ...
		 * {@link Pango.layout_context_changed} in response to them.
		 ...
		 * @returns a pointer to a {@link Actor},
		 *   or %NULL
		 */
		 ...
		 * @returns a pointer to the {@link Content}
		 ...
		 * @returns a {@link Transition}, or %NULL if
		 ...
		 * implementations overriding the {@link {@link ActorClass}.get.paint_volume}
		 ...
		 * 
		 * This function will call the {@link ActorClass}.paint() virtual
		 * function.
		 * 
		 ...
		 * 
		 * a pointer to an #ClutterActor
		 */
		pick_frame_clock(): [ FrameClock | null, Actor | null ];
		/**
		 ...
		 * @param pick_context a {@link PickContext}
	...
	class ActorNode {
		...
		public static new(actor: Actor, opacity: number): PaintNode;
	}
	...
	/** This construct is only for enabling class multi-inheritance,
	 * use {@link BlitNode} instead.
	 */
	interface IBlitNode {
		/**
		 * Adds a new blit rectangle to the stack of rectangles. All the
		 * constraints of {@link Cogl.blit.framebuffer} apply here.
	...
	type BlitNodeInitOptionsMixin = PaintNodeInitOptions
	export interface BlitNodeInitOptions extends BlitNodeInitOptionsMixin {}

	/** This construct is only for enabling class multi-inheritance,
	 * use {@link BlitNode} instead.
	 */
	type BlitNodeMixin = IBlitNode & PaintNode;

	interface BlitNode extends BlitNodeMixin {}

	class BlitNode {
		public constructor(options?: Partial<BlitNodeInitOptions>);
		/**
		 * Creates a new {@link BlitNode} that blits #src into the current
		 * draw framebuffer.
		 * 
		 * You must only add rectangles using {@link Clutter.BlitNode.add_blit_rectangle}.
		 * @param src the source #CoglFramebuffer
		 * @returns the newly created {@link BlitNode}.
		 *   Use {@link Clutter.PaintNode.unref} when done.
		 */
		public static new(src: Cogl.Framebuffer): PaintNode;
	}
	...
	/** This construct is only for enabling class multi-inheritance,
	 * use {@link BlurNode} instead.
	 */
	interface IBlurNode {

	}

	type BlurNodeInitOptionsMixin = LayerNodeInitOptions
	export interface BlurNodeInitOptions extends BlurNodeInitOptionsMixin {}

	/** This construct is only for enabling class multi-inheritance,
	 * use {@link BlurNode} instead.
	 */
	type BlurNodeMixin = IBlurNode & LayerNode;

	/**
	 * The {@link BurNode} structure is an opaque
	 * type whose members cannot be directly accessed.
	 */
	interface BlurNode extends BlurNodeMixin {}

	class BlurNode {
		public constructor(options?: Partial<BlurNodeInitOptions>);
		/**
		 * #width width of the blur layer
		 * Creates a new {@link BlurNode}.
		 * 
		 ...
		 * @returns the newly created {@link BlurNode}.
		 *   Use {@link Clutter.PaintNode.unref} when done.
		 */
		public static new(width: number, height: number, sigma: number): PaintNode;
	}
	...
	class FrameClock {
		...
		public static new(refresh_rate: number, vblank_duration_us: number, iface: FrameListenerIface): FrameClock;
	}
	...
	interface IInputDevice {
		...
		connect(signal: "notify::n-buttons", callback: (owner: this, ...args: any) => void): number;
	...
	interface IKeymap {
		...
		connect(signal: "notify::caps-lock-state", callback: (owner: this, ...args: any) => void): number;
		connect(signal: "notify::num-lock-state", callback: (owner: this, ...args: any) => void): number;
	...
	class LayerNode {
		...
		public static new(projection: Graphene.Matrix, viewport: cairo.Rectangle, width: number, height: number, opacity: number): PaintNode;
		/**
		 * Creates a new {@link LayerNode} that will redirect drawing at
		 ...
		 * @returns the newly created {@link LayerNode}.
		 *   Use {@link Clutter.PaintNode.unref} when done.
		 */
		public static new_to_framebuffer(framebuffer: Cogl.Framebuffer, pipeline: Cogl.Pipeline): PaintNode;
	}
	...
	interface IPaintNode {
		 ...
		 * instead of calling {@link Clutter.PaintNode.add_rectangle} separately for
		 ...
		 *   (x2, y2).
		 * @param n_rects number of rectangles defined in #coords.
		 */
		add_rectangles(coords: number[], n_rects: number): void;
		/**
		 ...
		 * 
		 * See {@link Cogl.Framebuffer.draw_textured_rectangles}.
		 ...
		 * @param n_rects number of rectangles defined in #coords.
		 */
		add_texture_rectangles(coords: number[], n_rects: number): void;
		/**
	...
	interface ISettings {
		 ...
		 * a string that can be passed to {@link Pango.font_description_from_string}.
		 */
		font_name: string;
		/**
	...
	interface IStage {
		 ...
		 * {@link Clutter.Stage.paint_to_buffer} or clutter_stage_paint_to_framebuffer()
		...
		/**
		 * Retrieves the {@link Actor} underneath the pointer or touch point
		...
		get_device_coords(device: InputDevice, sequence: EventSequence, coords: Graphene.Point): void;
		 ...
		 * @param paint_flags the {@link PaintFlag}
		...
		/**
		 * Take a snapshot of the stage to a {@link Content}.
		 * @param rect a #cairo_rectangle_int_t
		 * @param scale the scale
		 * @param paint_flags the {@link PaintFlag}
		 * @returns the {@link Content} or %NULL on error.
		 */
	...
	interface IStageView {
		...
		connect(signal: "notify::vblank-duration-us", callback: (owner: this, ...args: any) => void): number;
	...
	interface IText {
		 ...
		 * that can be parsed by {@link Pango.font_description_from_string}.
		 * 
		 ...
		 * {@link Pango.layout_set_markup} in the Pango documentation.
		 * 
		 ...
		 * so you can safely call {@link Pango.font_description_free} on it after
		 ...
		 * be parsed by the {@link Pango.font_description_from_string} function,
		 * like:
		 * 
		 * |[
	...
	class Text {
		 ...
		 * @returns the newly created {@link Text} actor
		 */
		public static new_full(font_name: string, text: string, color: Color): Actor;
		/**
		 * Creates a new entry with the specified text buffer.
		 * @param buffer The buffer to use for the new {@link Text}.
		 * @returns a new {@link Text}
		 */
		public static new_with_buffer(buffer: TextBuffer): Actor;
		/**
		 * Creates a new {@link Text} actor, using #font_name as the font
		 * description; #text will be used to set the contents of the actor.
		 * 
		 ...
		 * @returns the newly created {@link Text} actor
		 */
		public static new_with_text(font_name: string | null, text: string): Actor;
	}
	...
	class TransformNode {
		...
		public static new(projection: Graphene.Matrix): PaintNode;
	}
	...
	class ActorIter {
		 ...
		 * {@link Actor}
		 */
		public next(): [ boolean, Actor | null ];
		/**
		 ...
		 *   {@link Actor}
		 */
		public prev(): [ boolean, Actor | null ];
		/**
	...
	class Frame {
		...
		public has_result(): boolean;
		public set_result(result: FrameResult): void;
	}
	...
	class FrameInfo {
		...
		public flags: FrameInfoFlag;
		public sequence: number;
		public gpu_rendering_duration_ns: number;
		public cpu_time_before_buffer_swap_us: number;
	}
	...
	class MotionEvent {
		 ...
		 */
		public device: InputDevice;
		public time_us: number;
		public dx: number;
		public dy: number;
		public dx_unaccel: number;
		public dy_unaccel: number;
	}
	...
	class PickContext {
		...
		public destroy(): void;
		public get_mode(): PickMode;
		/**
		 * Retrieves the current transform of the pick stack.
		 * @returns a #graphene_matrix_t
		 */
		public get_transform(): Graphene.Matrix;
		/**
		 * Logs a pick rectangle into the pick stack.
		 * @param box a {@link ActorBox}
		 * @param actor a {@link Actor}
		 */
		public log_pick(box: ActorBox, actor: Actor): void;
		/**
		 * Pops the current clip rectangle from the clip stack. It is a programming
		 * error to call this without a corresponding {@link Clutter.PickContext.push_clip}
		 * call first.
		 */
		public pop_clip(): void;
		/**
		 * Pops the current transform from the clip stack. It is a programming error
		 * to call this without a corresponding {@link Clutter.PickContext.push_transform}
		 * call first.
		 */
		public pop_transform(): void;
		/**
		 * Pushes a clip rectangle defined by #box into the pick stack. Pop with
		 * {@link Clutter.PickContext.pop_clip} when done.
		 * @param box a {@link ActorBox}
		 */
		public push_clip(box: ActorBox): void;
		/**
		 * Pushes #transform into the pick stack. Pop with
		 * {@link Clutter.PickContext.pop_transform} when done.
		 * @param transform a #graphene_matrix_t
		 */
		public push_transform(transform: Graphene.Matrix): void;
	...
	interface IEvent {
		 ...
		 * pointer position. Unlike {@link Clutter.event.get_gesture_motion_delta},
